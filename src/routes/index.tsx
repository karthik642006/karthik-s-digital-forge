...
export const Route = createFileRoute("/")({
  head: () => ({ meta: [
    { title: "Karthik K | Full Stack Developer" },
    { name: "description", content: "Karthik K — Computer Science Engineer and Full Stack Developer." },
    { property: "og:title", content: "Karthik K | Full Stack Developer" },
    { property: "og:description", content: "Karthik K — Computer Science Engineer and Full Stack Developer." },
    { property: "og:type", content: "website" },
    { property: "og:image", content: "https://karthik-s-digital-forge.vercel.app/og-image.svg" },
    { property: "og:image:alt", content: "Karthik K — Full Stack Developer" },
    { name: "twitter:card", content: "summary_large_image" },
    { name: "twitter:title", content: "Karthik K | Full Stack Developer" },
    { name: "twitter:description", content: "Karthik K — Computer Science Engineer and Full Stack Developer." },
    { name: "twitter:image", content: "https://karthik-s-digital-forge.vercel.app/og-image.svg" },
  ] }), component: Portfolio,
});
...
function Portrait() { return <motion.div initial={{ opacity: 0, scale: .96 }} animate={{ opacity: 1, scale: 1 }} transition={{ delay: .25 }} className="relative mx-auto aspect-[4/5] w-full max-w-sm overflow-hidden rounded-md border border-border bg-surface shadow-2xl"><ProfileImage src="https://github.com/karthik642006.png" alt="Portrait of Karthik"/><div className="pointer-events-none absolute inset-3 border border-border"/><div className="absolute bottom-5 left-5 right-5 flex items-center justify-between rounded-md border border-border bg-surface/85 px-4 py-3 backdrop-blur-xl"><span className="font-mono text-xs">KARTHIK.DEV</span><span className="flex items-center gap-2 text-[10px] uppercase text-primary"><span className="size-1.5 animate-pulse rounded-full bg-primary"/>Online</span></div></motion.div>; }
